...
class GroundingNetInput:
    ...
    def prepare(self, batch):
        ...
        return {"rbboxes": rbboxes, "masks": masks, "positive_embeddings": positive_embeddings, "points":points, "kp_masks":kp_masks}
    ...
    def get_null_input(self, batch=None, device=None, dtype=None):
        ...
        rbboxes = th.zeros(batch, self.max_box, 5).type(dtype).to(device)
